...
public class Ejercicios_1 {
	...
	public static void sayHelloWorldTwo(String x) {
		System.out.println(x);
	}
	
	//3- Escribir un programa que pregunte el nombre del usuario en la consola y
	//después la muestre por pantalla la cadena “Hola &lt;nombre&gt;” donde
	//&lt;nombre&gt; es el nombre introducido por le usuario.
	...
	private static void operacion() {
		double resultado = Math.pow((3.0+2.0)/(2.0*5.0), 2.0);
